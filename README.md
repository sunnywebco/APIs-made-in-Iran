...
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
:question: | [API بازار بورس تهران](http://db.api.mabnadp.com/) | شامل کلیه اطلاعات مالی، اخبار و معاملات و سایر داده‌های بازار بورس تهران
:question: | [API سرویس واژه یاب](https://www.vajehyab.com/api) |  برای جستجوی معانی کلمات در فرهنگ‌نامه‌های مختلف
:question: | [API پارسا اسپیس](http://api.parsaspace.com/) | سرویس فایل هاستینگ
:question: | [API شبکه اجتماعی پروفایل](https://developers.profile.ir/) | دسترسی به اطلاعات عمومی ثبت‌شده کاربران و تصویر پروفایل
:question: | [API سرویس recommender](http://recommender.ir/) | سرویس ارائه خدمات شخصی‌سازی محتوا
:question: | [API تلسا](http://telesa.ir/) | سرویس‌های مبتنی بر صوت شامل پیام صوتی، تبدیل متن به گفتار
:question: | [API شارژ تلفن همراه](http://ws.toshanet.ir/) | خدمات شارژ تلفن همراه
:question: | [API فیلم‌ها](http://moviesapi.ir/) | اطلاعات فیلم‌های برتر
:question: | [API بکتوری](https://backtory.com/) | یک ارائه‌دهنده دیگر خدمات Backend as a Service
:question: | [API گپ](https://my.gap.im/doc/) | API ساخت ربات، ورود با اکانت گپ و گیم سنتر پیام رسان گپ
:question: | [API بهنویس](http://behnevis.com/api.html) | تبدیل پینگلیش به فارسی 
:question: | [API حافظ](http://emrani.net/hafez/Api) | لیست غزلیات حافظ با امکان جستجو و فال
:moneybag:  | [API پارسی جو](http://csi.parsijoo.ir/) | جستجوی وب، قیمت ارز و سکه، آب و هوا و نقشه بر اساس خدمات سایت جستجوگر ایرانی پارسی جو
:question: | [API لحظه‌نگار](http://docs.lahzenegar.com/api/) | پلتفرم عمومی پخش زنده اینترنتی لحظه‌نگار
:question: | [API ابر آروان](https://api.arvancloud.com/video/doc/) | خدمات پلتفرم ویدئوی ابر آروان
:question: | [API آپارات](https://www.aparat.com/api) | اطلاعات کانال‌ها، پروفایل‌ها و ویدئوهای سایت آپارات
:question: | [API سخنک](http://sokhanak.com/api/) | بانک سخن بزرگان
:question: | [API کپچای متنی](http://textcaptcha.ir/api) | سرویس ارائه کپچای متنی فارسی
:question: | [API رایچت](https://www.raychat.io/api) | پلتفرم گفتگوی آنلاین و ارتباط با مشتریان
:question: | [API اوقات شرعی](http://prayer.aviny.com/PrayerTimes-WebService.aspx) | سرویس جهت دریافت اوقات شرعی شهرهای ایران
:question: | [API دیجی سروی](http://www.digisurvey.net/apihelp) | سرویس ایجاد پرسشنامه و آزمون آنلاین
:question: | [API آریانا](http://www.farsireader.com/connection/) | سرویس متن به گفتار فارسی
:question: | [API گنجور](https://github.com/ganjoor/ganjoor-api) | گنجور، مخزن اشعار فارسی
...
:question: | [API وب‌آلفا](https://www.webalfa.net/kb/api-v2-manual) | API برای ثبت و تمدید و انتقال و به‌روزرسانی و دریافت اطلاعات دامنه‌های ir
...
:question: | [API آی‌گپ](https://github.com/RooyeKhat-Media/iGap-API) | پیام‌رسان ایرانی آی‌گپ
:question: | [API نوآوران امین](http://www.nadpco.com/#/HelpAPI) | سرویس اطلاعات بازار بورس تهران
:question: | [API مَخلص](http://makhlas.com/api) | سرویس لینک کوتاه بروی دامنه اختصاصی
:question: | [API کامنتوم](http://commentum.ir/) | ایده‌کاوی در متن‌های کوتاه فارسی
:question: | [API پیام‌رسان بله](https://dev.bale.ai/) | توضیحات مربوط به برنامه‌نویسی برای پیام‌رسان بله
:question: | [API چابک](https://api.doc.chabokpush.com/) | سرویس پوش نوتیفیکیشن چابک
:question: | [API پایگاه اطلاع رسانی دفتر حفظ و نشر آثار حضرت آیت الله خامنه ای ](http://farsi.khamenei.ir/help-content?id=21881) | خروجی محتوا وب سایت پایگاه اطلاع رسانی دفتر حفظ و نشر آثار حضرت آیت الله خامنه ای
...
:question: | [API نیواد](https://nivad.io/docs/home/) | نیواد ارائه‌دهنده Backend as a Service برای ساخت بازی، اپلیکیشن و وب‌سایت‌ است
:question: | [API بیت والت](https://bitwallet.ir/developers/documents) | بیت والت کیف پول بیت کوین با کلید سخت‌افزاری است
:question: | [API مستر۲اپ](http://mr2app.com/blog/app-build-api/) | سرویس ساخت اپلیکیشن بر اساس محتوای سایت
:question: | [API ساخت QR Code](http://qr-code.ir/api/) | سرویس ساخت QR Code با قابلیت سفارشی سازی ابعاد و ایجاد کد برای محتوای وردپرس و بلاگفا و رزبلاگ
:question: | [API دیتابین](http://databeen.ir/documents) | سرویس زیرساخت تحلیل داده اپلیکیشنهای موبایلی
:question: | [API آوانک](https://www.avanak.ir/webservice) | سرویس پیام صوتی
:question: | [API ژاکت](https://zhaket.github.io/guard/) | سرویس تعریف لایسنس برای ابزارهای وردپرسی
:question: | [API واکاویک](http://docs.vakavic.com/) | سرویس پردازش متن با قابلیت‌هایی نظیر دسته‌بندی و خلاصه‌کردن متن و نظارت بر کامنت‌ها
:question: | [API فارس‌نت](http://farsnet.nlp.sbu.ac.ir/Site3/Modules/Public/Default.jsp) | سرویس قابل استفاده در دات‌نت و جاوا برای شبکه واژگانی مورد استفاده در پردازش زبان طبیعی فارسی
...
:question: | [API های هالیدی](http://hiholiday.ir/webservice) | سرویس پروازهای چارتر و هتل‌های ایران
:question: | [API زال](https://miras-tech.github.io/zaal/) | سرویس پردازش زبان طبیعی (NLP) زال
:free::moneybag: | [API حساب‌فا](https://api.hesabfa.com) | سرویس حسابداری آنلاین 
:question: | [API پیام‌رسان سروش](https://soroush-app.ir/developer.html) | پیام‌رسان ایرانی سروش
:question: | [API خدمات شهری تهران](http://api.tehran.ir/) | مجموعه اطلاعات شهری تهران با قابلیت درخواست API
:moneybag: | [API منحنی](https://planner.monhani.ir/) | API برای برنامه‌ریزی سفر
:question: | [API نجوا](https://www.najva.com/blog/1397/) | سرویس پوش نوتیفیکیشن نجوا
:question: | [API پست بار](https://postbar.ir/%D9%86%D8%AD%D9%88%D9%87-%D8%A7%D8%B3%D8%AA%D9%81%D8%A7%D8%AF%D9%87-%D8%A7%D8%B2-api-%D9%BE%D8%B3%D8%AA-%D8%A8%D8%A7%D8%B1) | سرویس حمل و نقل بار پستی
:free: | [API نوبیتکس](https://nobitex.market/api) | پلتفرم مبادله بیت‌کوین و سایر رمزارزها
:question: | [API سرویس IoType](https://www.iotype.com/api) | سرویس تبدیل گفتار به نوشتار
...
:moneybag: | [API پی پینگ ](https://docs.payping.ir/) | سرویس درگاه شبکه پرداخت پی پینگ
...
:question: | [API رسید](https://resid.ir/docs/) | سرویس پرداخت کرایه تاکسی
:moneybag: | [API جیب](https://jeeb.io/documentation) | درگاه پرداخت امن و ناشناس با بیت‌کوین
:question: | [API اول‌مارکت](http://avvalmarket.readthedocs.io/fa/latest/) | پرداخت درون برنامه‌ای و خدمات اول مارکت
...
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
 :question: | [API متن‌کاوی](https://api.text-mining.ir) | مجموعه API برای پردازش متن و متن‌کاوی فارسی [مستندات](https://docs.text-mining.ir)
 :question: | [API ترگمان](http://api.targoman.com/) | خدمات ترجمه ماشینی
 :question: | [API دیتاک](https://sakoo.dataak.com/) | دیتاست‌ها و API‌ در حوزه پردازش متن. توضیحات و نمونه کد هر API در خود ابزار درج شده است
...
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
:question: | [API سرویس Adeto](https://adeto.ir/developers/api) | سرویس تبلیغات تعاملی آنلاین و نمایش کپچای تبلیغاتی 
...
وضعیت قیمت | لینک | موضوع
 ...
 :question: | [API فلوکس](https://phelox.ir/document) | درگاه مدیریت و ارائه خدمات حمل، بسته بندی، لجستیک و انبارداری فروشگاه های اینترنتیب
...
:free: | [API سامانه نظارت ارز - سنا](http://www.tgju.org/sanarate-service) | قیمت ارز سامانه نظارت ارز - سنا
 ...
 :moneybag:  | [API نرخ ارز و طلا و سکه](https://api.sunnyweb.ir/) | سرویس غیررایگان جهت دریافت نرخ ارز و طلا و سکه
...
وضعیت قیمت | لینک | موضوع
 ...
 :question: | [API سایت uses](http://uses.ir/about-manual) | سرویس کوتاه کننده لینک
...
وضعیت قیمت | لینک | موضوع
 | --- |--- | ---
:question: | [API نشان](https://developer.neshan.org/) | API توسعه نقشه نشان که برای دریافت آن نیاز به ثبت‌نام دارید
...
:question: | [API سیدار مپ](http://api.cedarmaps.com/docs/) | سرویس نقشه ایرانی با قابلیت‌هایی نظیر تبدیل نقطه جغرافیایی به آدرس و مکان یاب و جانمایی روی نقشه
:free::moneybag: | [API سایت map.ir](http://corp.map.ir/map-services/api-services/developers/) | یک سرویس دیگر نقشه ایرانی
:question: | [API پارسی مپ](https://www.parsimap.com/api/v2/docs/) | سرویس نقشه ایرانی با قابلیت استفاده عمومی یا اختصاصی
:question: | [API اطلاعات شهرداری مشهد](http://developer.mashhad.ir/web_directory/100147-%D9%81%D9%87%D8%B1%D8%B3%D8%AA-API.html) | اطلاعات شاخص کیفیت هوا، ظرفیت لحظه‌ای پارکنیگ‌ها و نقشه و اطلاع‌رسانی اتوبوسرانی. برای دریافت اطلاعات نیازمند تماس هستید
